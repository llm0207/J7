...
namespace J7.Redis
{
    ...
    /// 配置如下：
    /// <configSections>    
    ///     <section name="RedisConfig" type="J7.Redis.RedisConfig, J7.Demo"/>
    /// </configSections>
    /// <RedisConfig WriteServerList="192.168.1.18:6379" ReadServerList="192.168.1.18:6379" MaxWritePoolSize="60" MaxReadPoolSize="60" AutoStart="true" LocalCacheTime="180" RecordeLog="false"/>
    /// </summary>
    public sealed class RedisConfig : ConfigurationSection
    {
        public static RedisConfig GetConfig()
        {
            ...
            if (section == null)
            {
                throw new ConfigurationErrorsException("Redis section is not found.");
            }
            return section;
        }
